...
function searchAddressHandler(event) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get(`https://maps.googleapis.com/maps/api/geocode/json?address=${encodeURI(enteredAddress)}&key=${apiKey}`)
        .then((res) => {
